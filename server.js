...
app.get('/player_info/post' ,function(req, res){
  //WIll only work after you get the option tag
  var id= req.query.player_choice
  console.log(id)
   var query1 = 'SELECT * FROM football_players where id='+id.toString();
   var query2 = 'select count(players) from football_games where '+ id.toString() +' = ANY (players)';
   ...
   db.task('get-everything', task => {
      ...
      .then(function (rows) {
        ...
        console.log(rows[0][0], rows[1][0].count)
          res.render('pages/player_info',{
  			my_title: "Player Info",
  			player_info: rows[0][0],
        games_played: rows[1][0].count,
        names: rows[2]
  		})
